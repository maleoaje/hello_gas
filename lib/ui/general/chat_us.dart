...
import 'package:hello_gas/model/general/chat_model.dart';
...
class _ChatUsPageState extends State<ChatUsPage> {
  ...
  void _initForLang() {
    setState(() {
      ...
      _chatList.add(new ChatModel(2, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message1')!, '13:59', true));
      _chatList.add(new ChatModel(3, 'buyer', 'image', GLOBAL_URL+'/assets/images/product/80.jpg', null, null));
      _chatList.add(new ChatModel(4, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message2')!, '13:59', true));
      _chatList.add(new ChatModel(5, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message3')!, '14:01', true));
      _chatList.add(new ChatModel(6, 'seller', 'text', AppLocalizations.of(context)!.translate('chat_message4')!, '14:18', true));
      _chatList.add(new ChatModel(7, 'seller', 'text', AppLocalizations.of(context)!.translate('chat_message5')!, '14:20', null));
      _chatList.add(new ChatModel(8, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message6')!, '14:22', true));
      ...
      _chatList.add(new ChatModel(11, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message7')!, '08:58', true));
      _chatList.add(new ChatModel(12, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message8')!, '09:00', true));
      _chatList.add(new ChatModel(13, 'buyer', 'text', AppLocalizations.of(context)!.translate('chat_message9')!, '09:00', true));
      _chatList.add(new ChatModel(14, 'seller', 'text', AppLocalizations.of(context)!.translate('chat_message10')!, '09:14', null));
                    ...
                    Flexible(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          hintText: AppLocalizations.of(context)!.translate('write_message')!,
