      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(AppLocalizations.of(context)!.translate('order_completed')!, style: TextStyle(
              ...
              GestureDetector(
                ...
                child: Text(AppLocalizations.of(context)!.translate('view_status')!, style: TextStyle(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(AppLocalizations.of(context)!.translate('order_date')!, style: TextStyle(
                  color: BLACK_GREY, fontSize: 13
              )),
            ...
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Text(countItem.toString()+' '+AppLocalizations.of(context)!.translate('item')!+'  ('+weight.toString()+' '+AppLocalizations.of(context)!.translate('gr')!+')', style: GlobalStyle.shoppingCartOtherProduct.copyWith(color: Colors.grey[400]))
                            ),
                            Container(
                              margin: EdgeInsets.only(top: 4),
              ...
              Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(AppLocalizations.of(context)!.translate('total_price')!, style: TextStyle(
                          fontSize: 12
                      )),
                      Container(
  ...
  Widget _createDeliveryDetail(){
    return Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(AppLocalizations.of(context)!.translate('delivery_details')!, style: TextStyle(
            ...
            Table(
              children: [
                TableRow(children: [
                  Container(
                    child: Text(AppLocalizations.of(context)!.translate('courier_delivery')!, style: TextStyle(
                      color: BLACK_GREY, fontSize: 13,
                    )),
                  ),
                  Container(
                ...
                TableRow(children: [
                  Container(
                    ...
                    child: Text(AppLocalizations.of(context)!.translate('awb_number')!, style: TextStyle(
                      color: BLACK_GREY, fontSize: 13,
                    )),
                  ),
                  Container(
                ...
                TableRow( children: [
                  Container(
                    margin: EdgeInsets.only(top: 8),
                    child: Text(AppLocalizations.of(context)!.translate('delivery_address')!, style: TextStyle(
                      color: BLACK_GREY, fontSize: 13,
                    )),
                  ),
                  Container(
  ...
  Widget _createPaymentInformation(){
    return Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(AppLocalizations.of(context)!.translate('payment_information')!, style: TextStyle(
                fontSize: 16, fontWeight: FontWeight.bold
            )),
            SizedBox(
              height: 16,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(AppLocalizations.of(context)!.translate('total_price')!+' (4 '+AppLocalizations.of(context)!.translate('item')!+')', style: TextStyle(
                    color: BLACK_GREY, fontSize: 13
                )),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(AppLocalizations.of(context)!.translate('total_delivery')!+' (1.3 Kg)', style: TextStyle(
                    color: BLACK_GREY, fontSize: 13
                )),
