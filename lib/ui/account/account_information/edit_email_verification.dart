...
class EditEmailVerificationPage extends StatefulWidget {
  ...
  const EditEmailVerificationPage({Key? key, this.email = ''}) : super(key: key);

  @override
  _EditEmailVerificationPageState createState() => _EditEmailVerificationPageState();
}
              ...
              child: TextButton(
                  ...
                  onPressed: () {
                    if(!_buttonDisabled){
                      ...
                      _globalFunction.startLoading(context, AppLocalizations.of(context)!.translate('edit_email_success')!, 2);
